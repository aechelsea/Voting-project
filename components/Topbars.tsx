  ...
  return (
    <nav className="flex justify-between items-center px-20 py-4 bg-darkbg">
      ...
      <img
        ...
        width="64px"
      />
      <div className="rounded-full md:px-8 sm:px-16 px-10 py-1 mt-4 bg-gradient-to-b from-indigo-500 to-darkblue-500 hover:bg-purple-700 border-2 border-bdpurple  text-white md:text-base text-xs font-bold ">
