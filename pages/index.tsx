  ...
  if (initial) {
    return (
      <div className="bg-darkbg min-h-screen flex items-center justify-center" >
        ...
        <svg role="status" className="inline w-36 h-36 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-orange-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
